...
city_dcc = df_data["City"].value_counts().index
    ...
    dbc.Row([
        dbc.Col([
            dbc.Card([
                ...
                html.H2("Banco BTG", style={"font-family": "Voltaire"}),
                html.Hr(),

                html.H5("Cidades:"),
                dcc.Checklist(city_dcc, city_dcc, id="check_city", inputStyle={"margin-right": "5px", "margin-left" : "20px"}),
...
#===============CallBacks==================#
@app.callback([Output('city_fig', 'figure'), Output('pay_fig', 'figure'), Output('gender_fig', 'figure'), Output('income_per_date_fig', 'figure'), Output('income_per_product_fig', 'figure')], 
